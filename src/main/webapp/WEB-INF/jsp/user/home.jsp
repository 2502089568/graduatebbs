...
<div class="fly-home fly-panel" >
   ...
   <%-- <i class="iconfont icon-renzheng" title="Fly社区认证"></i>--%>
    <h1>
        ${user.nickname}
        <%--<c:choose>
            <c:when test="${user.sex == 0}"><i class="iconfont icon-nan"></i></c:when>
            <c:otherwise><i class="iconfont icon-nv"></i></c:otherwise>
        </c:choose>--%>
        <%--<i class="layui-badge fly-badge-vip">VIP${user.vip_grade}</i>--%>
        <!--
    ...
    <p class="fly-home-info">
        ...
        <i class="iconfont icon-shijian"></i><span><fmt:formatDate value="${user.creatTime}" pattern="yyyy-MM-dd"/> 加入</span>
...
<div class="layui-container">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md6 fly-home-jie">
            <div class="fly-panel">
                <h3 class="fly-panel-title">${userTopic.userNickname} 最近的提问</h3>
                <ul class="jie-row">
                    <c:choose>
                        <c:when test="${list.size()==0}">
                             <div class="fly-none" style="min-height: 50px; padding:30px 0; height:auto;"><i style="font-size:14px;">没有发表任何求解</i></div>
                        </c:when>
                        <c:when test="${userTopic.title == null}">
                             <div class="fly-none" style="min-height: 50px; padding:30px 0; height:auto;"><i style="font-size:14px;">没有发表任何求解</i></div>
                        </c:when>
                        <c:otherwise>
        ...
        <div class="layui-col-md6 fly-home-da">
            <div class="fly-panel">
                <h3 class="fly-panel-title">${userTopic.nickname} 最近的回答</h3>
               <%-- <ul class="home-jieda">
                    <c:choose>
